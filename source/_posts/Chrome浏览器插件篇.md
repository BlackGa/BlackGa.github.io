...
![chrome应用商店](Chrome浏览器插件篇/chrome应用商店.png)
##### <font size="3">◇ 在国内的chrome插件网站进行下载</font>
![chrome浏览器插件](Chrome浏览器插件篇/chrome浏览器插件.png)
##### <font size="4">◇ 如何安装chrome插件</font>
###### chrome应用商店进行安装
打开chrome应用商店，搜索想要安装的插件名称，下面拿“Google翻译”进行举例
![插件安装1](Chrome浏览器插件篇/插件安装1.png)
![插件安装2](Chrome浏览器插件篇/插件安装2.png)
点击添加扩展程序之后会弹出下面这个提示框
![插件安装3](Chrome浏览器插件篇/插件安装3.png)
chrome商店会展示成这样
![插件安装4](Chrome浏览器插件篇/插件安装4.png)
然后咱们来演示一下如何使用，访问一下linux网站进行测试
![linux](Chrome浏览器插件篇/linux.png)
地址栏会出现此对话框，点击翻译
![插件安装5](Chrome浏览器插件篇/插件安装5.png)
现在整个页面就变成中文的了~
![linux2](Chrome浏览器插件篇/linux2.png)
###### 国内chrome插件网站下载安装
可以从下面三个网站进行搜索下载插件：
...
![插件安装6](Chrome浏览器插件篇/插件安装6.png)
点击下载
![插件安装7](Chrome浏览器插件篇/插件安装7.png)
再次点击下载
![插件安装8](Chrome浏览器插件篇/插件安装8.png)
此时已下载，chrome浏览器进行安全提示，点击保留
![插件安装9](Chrome浏览器插件篇/插件安装9.png)
下载完成之后的都是拓展名为 **.crx 的文件
![插件安装10](Chrome浏览器插件篇/插件安装10.png)
下载之后进行安装
![插件安装11](Chrome浏览器插件篇/插件安装11.png)
安装之前必须要打开开发者模式
![插件安装12](Chrome浏览器插件篇/插件安装12.png)
安装步骤：
1.直接拖至扩展程序页
2.然后弹出对话框，点击添加扩展程序
3.安装完成之后打开新的标签页
![install](Chrome浏览器插件篇/install.gif)
之后每次新打开标签页都会是这样的页面。右下角的小风车点击可以更换背景哦~
![插件安装13](Chrome浏览器插件篇/插件安装13.webp)
